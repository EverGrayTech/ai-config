...
- [x] Phase 1: Clarify and document the current React integration contract
- [x] Phase 2: Define embedding-safe layout ownership
- [x] Phase 3: Tighten the styling contract
- [x] Phase 4: Evaluate lightweight React-layer extension points
